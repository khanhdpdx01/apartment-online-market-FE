                 ...
                 <el-card class="box-card">
                    <el-row>
                        ...
                        <el-col :span="16" v-if="is_update==false">
                            <el-row style="float:right;"><el-button type="danger" @click="is_update=true">Chỉnh sửa</el-button></el-row>
                            <el-row style="font-size:25px; margin-top: 50px;">
                                <el-col :span="10"></el-col>
                                <el-col :span="14"><b>{{product.name}}</b></el-col>
                            </el-row>
                            <el-row>
                        ...
                        <el-col :span="16" v-if="is_update">
                            <el-row style="float:right;"><el-button type="primary" @click="Update()">Lưu thay đổi</el-button></el-row>
                            <el-row style=" margin: 50px 20px 20px 20px;">
                                <el-col :span="6">Name Product</el-col>
                                <el-col :span="18"><el-input v-model="product.name"></el-input></el-col>
                            </el-row>
                            <el-row style="margin: 20px;">
                                <el-col :span="6">Price</el-col>
                                <el-col :span="18"><el-input-number v-model="product.price"></el-input-number></el-col>
                            </el-row>
                            <el-row style="margin: 20px;">
                                <el-col :span="6">Quantity</el-col>
                                <el-col :span="18"><el-input-number v-model="product.quantity"></el-input-number></el-col>
                            </el-row>
                            <el-row>
                                <el-col :span="6">Description</el-col>
                                <el-col :span="18"><el-input v-model="product.description" type="textarea"></el-input></el-col>
                            </el-row>
                        </el-col>
                    </el-row>
                </el-card>
